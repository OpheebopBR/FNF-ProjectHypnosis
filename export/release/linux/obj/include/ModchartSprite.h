...
class HXCPP_CLASS_ATTRIBUTES ModchartSprite_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< ModchartSprite_obj > __new( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic);
		static ::hx::ObjectPtr< ModchartSprite_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic);
