...
::options::ControllerSubState_obj::__register();
...
::__ASSET__manifest_videos_json_obj::__register();
...
::__ASSET__manifest_videos_json_obj::__boot();
...
::options::ControllerSubState_obj::__boot();
