...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_78_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",78,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_133_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",133,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_142_coolStartDeath,"GameOverSubstate","coolStartDeath",0x265fa8f2,"GameOverSubstate.coolStartDeath","GameOverSubstate.hx",142,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_147_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",147,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_157_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",157,0x01fbc1e7)
...
HXLINE( 138)		this->isEnding = false;
HXLINE(  76)		this->isFollowingAlready = false;
...
HXLINE(  55)		if (::ClientPrefs_obj::maxOptimization) {
HXLINE(  55)			this->boyfriend->revive();
            		}
...
HXLINE(  71)		this->camFollowPos =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  72)		this->camFollowPos->setPosition((::flixel::FlxG_obj::camera->scroll->x + (( (Float)(::flixel::FlxG_obj::camera->width) ) / ( (Float)(2) ))),(::flixel::FlxG_obj::camera->scroll->y + (( (Float)(::flixel::FlxG_obj::camera->height) ) / ( (Float)(2) ))));
HXLINE(  73)		this->add(this->camFollowPos);
            	}
...
void GameOverSubstate_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_78_update)
HXLINE(  79)		this->super::update(elapsed);
HXLINE(  81)		::PlayState_obj::instance->callOnLuas(HX_("onUpdate",88,7c,b2,66),::cpp::VirtualArray_obj::__new(1)->init(0,elapsed));
HXLINE(  82)		if (this->updateCamera) {
HXLINE(  83)			Float lerpVal = ::Math_obj::max(( (Float)(0) ),::Math_obj::min(( (Float)(1) ),(elapsed * ((Float)0.6))));
HXLINE(  84)			Float a = this->camFollowPos->x;
HXDLIN(  84)			Float a1 = this->camFollowPos->y;
HXDLIN(  84)			this->camFollowPos->setPosition((a + (lerpVal * (this->camFollow->x - a))),(a1 + (lerpVal * (this->camFollow->y - a1))));
            		}
HXLINE(  87)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  89)			this->endBullshit();
            		}
HXLINE(  92)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  94)			{
HXLINE(  94)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN(  94)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE(  95)			::PlayState_obj::deathCounter = 0;
HXLINE(  96)			::PlayState_obj::seenCutscene = false;
HXLINE(  97)			::PlayState_obj::instance->setOnLuas(HX_("seenCutscene",25,d1,95,b5),false);
HXLINE(  99)			if (::PlayState_obj::isStoryMode) {
HXLINE( 100)				::MusicBeatState_obj::switchState( ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null()));
            			}
            			else {
HXLINE( 102)				::MusicBeatState_obj::switchState( ::FreeplayState_obj::__alloc( HX_CTX ,null(),null()));
            			}
HXLINE( 104)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 104)			::String library = null();
HXDLIN( 104)			::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 104)			 ::Dynamic _hx_tmp1;
HXDLIN( 104)			if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 104)				if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 104)					::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 104)					( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            				}
HXDLIN( 104)				_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            			}
            			else {
HXLINE( 104)				_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            			}
HXDLIN( 104)			_hx_tmp->playMusic(_hx_tmp1,null(),null(),null());
HXLINE( 105)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,false));
            		}
HXLINE( 108)		if ((this->boyfriend->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE( 110)			bool _hx_tmp;
HXDLIN( 110)			if ((this->boyfriend->animation->_curAnim->curFrame >= 12)) {
HXLINE( 110)				_hx_tmp = !(this->isFollowingAlready);
            			}
            			else {
HXLINE( 110)				_hx_tmp = false;
            			}
HXDLIN( 110)			if (_hx_tmp) {
HXLINE( 112)				::flixel::FlxG_obj::camera->follow(this->camFollowPos,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),1);
HXLINE( 113)				this->updateCamera = true;
HXLINE( 114)				this->isFollowingAlready = true;
            			}
HXLINE( 117)			if (this->boyfriend->animation->_curAnim->finished) {
HXLINE( 119)				this->coolStartDeath(null());
HXLINE( 120)				this->boyfriend->startedDeath = true;
            			}
            		}
HXLINE( 124)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 126)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
HXLINE( 128)		::PlayState_obj::instance->callOnLuas(HX_("onUpdatePost",08,11,55,db),::cpp::VirtualArray_obj::__new(1)->init(0,elapsed));
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_133_beatHit)
HXDLIN( 133)		this->super::beatHit();
            	}
...
void GameOverSubstate_obj::coolStartDeath( ::Dynamic __o_volume){
            	...
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_142_coolStartDeath)
HXDLIN( 142)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 142)		::String key = ::GameOverSubstate_obj::loopSoundName;
HXDLIN( 142)		::String library = null();
HXDLIN( 142)		::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 142)		 ::Dynamic _hx_tmp1;
HXDLIN( 142)		if (::sys::FileSystem_obj::exists(file)) {
HXDLIN( 142)			if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXDLIN( 142)				::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 142)				( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            			}
HXDLIN( 142)			_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            		}
            		else {
HXDLIN( 142)			_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            		}
HXDLIN( 142)		_hx_tmp->playMusic(_hx_tmp1,volume,null(),null());
            	}
...
void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_147_endBullshit)
HXDLIN( 147)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_157_endBullshit)
HXLINE( 157)					::MusicBeatState_obj::resetState();
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_155_endBullshit)
HXLINE( 155)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 149)			this->isEnding = true;
HXLINE( 150)			this->boyfriend->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 151)			{
...
HXDLIN( 152)			::String key = ::GameOverSubstate_obj::endSoundName;
HXDLIN( 152)			::String library = null();
HXDLIN( 152)			::String file = ::Paths_obj::modFolders((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)));
HXDLIN( 152)			 ::Dynamic _hx_tmp1;
HXDLIN( 152)			if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 152)				if (!(::Paths_obj::customSoundsLoaded->exists(file))) {
HXLINE( 152)					::Dynamic this1 = ::Paths_obj::customSoundsLoaded;
HXDLIN( 152)					( ( ::haxe::ds::StringMap)(this1) )->set(file,::openfl::media::Sound_obj::fromFile(file));
            				}
HXDLIN( 152)				_hx_tmp1 = ::Paths_obj::customSoundsLoaded->get(file);
            			}
            			else {
HXLINE( 152)				_hx_tmp1 = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            			}
HXDLIN( 152)			_hx_tmp->play(_hx_tmp1,null(),null(),null(),null(),null());
HXLINE( 153)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
HXLINE( 160)			::PlayState_obj::instance->callOnLuas(HX_("onGameOverConfirm",db,ac,91,0d),::cpp::VirtualArray_obj::__new(1)->init(0,true));
            		}
            	}
