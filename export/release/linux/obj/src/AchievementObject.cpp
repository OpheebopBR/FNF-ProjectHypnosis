...
HXDLIN( 136)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("achievementgrid",b5,fa,02,8a));
HXDLIN( 136)		 ::Dynamic achievementIcon1;
HXDLIN( 136)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 136)			achievementIcon1 = imageToReturn;
            		}
            		else {
HXLINE( 136)			achievementIcon1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("achievementgrid",b5,fa,02,8a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
HXDLIN( 136)		 ::flixel::FlxSprite achievementIcon2 = achievementIcon->loadGraphic(achievementIcon1,true,150,150,null(),null());
HXLINE( 137)		achievementIcon2->animation->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,id),0,false,false,null());
HXLINE( 138)		achievementIcon2->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
HXLINE( 139)		achievementIcon2->scrollFactor->set(null(),null());
HXLINE( 140)		achievementIcon2->setGraphicSize(::Std_obj::_hx_int((achievementIcon2->get_width() * ((Float)0.66666666666666663))),null());
HXLINE( 141)		achievementIcon2->updateHitbox();
HXLINE( 142)		achievementIcon2->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 144)		Float achievementIcon3 = achievementIcon2->x;
HXDLIN( 144)		Float achievementName = ((achievementIcon3 + achievementIcon2->get_width()) + 20);
HXDLIN( 144)		 ::flixel::text::FlxText achievementName1 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,achievementName,(achievementIcon2->y + 16),280,( (::String)(::Achievements_obj::achievementsStuff->__get(id)->__GetItem(0)) ),16,null());
...
HXLINE( 155)		this->add(achievementIcon2);
...
HXLINE( 165)		achievementIcon2->set_cameras(cam);
