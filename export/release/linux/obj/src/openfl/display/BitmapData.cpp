...
HXLINE(1372)			_hx_tmp2 = ::hx::IsInstanceNotEq( this->_hx___indexBufferContext,context->_hx___context );
            		}
            		else {
...
HXLINE(1589)			_hx_tmp3 = ::hx::IsInstanceNotEq( this->_hx___vertexBufferContext,context->_hx___context );
            		}
            		else {
...
HXLINE(2177)			_hx_tmp = ::hx::IsInstanceNotEq( this->_hx___textureContext,context->_hx___context );
            		}
            		else {
...
HXLINE(3046)		if (::hx::IsInstanceEq( source,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(3171)		 ::lime::graphics::Image image = ::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes));
...
HXDLIN(3251)		 ::openfl::display::BitmapData _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN(3264)		 ::openfl::display::BitmapData _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(3266)		return ::lime::graphics::Image_obj::loadFromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes))->then( ::Dynamic(new _hx_Closure_0(rawAlpha,_gthis)));
            	}
...
HXDLIN(3283)		 ::openfl::display::BitmapData _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(1231)		{
HXLINE(1231)			 ::lime::graphics::Image image = ::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes));
...
HXDLIN(2483)		return ::lime::graphics::Image_obj::loadFromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes))->then( ::Dynamic(new _hx_Closure_0(rawAlpha)));
            	}
