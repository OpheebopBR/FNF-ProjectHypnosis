...
HXLINE(2003)		if (::hx::IsInstanceEq( value,this->_hx___mask )) {
HXLINE(2005)			return value;
            		}
HXLINE(2008)		if (::hx::IsInstanceNotEq( value,this->_hx___mask )) {
...
HXLINE(2029)			_hx_tmp = ::hx::IsInstanceNotEq( this->_hx___cacheBitmap->get_mask(),value );
            		}
            		else {
