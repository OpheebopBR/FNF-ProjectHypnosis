...
HX_LOCAL_STACK_FRAME(_hx_pos_dec05f81178ee6ce_147_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","/usr/share/haxe/std/sys/thread/EventLoop.hx",147,0x36352808)
namespace sys{
namespace thread{
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_dec05f81178ee6ce_147_loop)
