...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_126_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",126,0x9f143813)
...
HXDLIN( 119)		::Dynamic _hx_tmp = ::openfl::utils::Assets_obj::cache;
HXDLIN( 119)		if (!(::openfl::utils::IAssetCache_obj::hasSound(_hx_tmp,::Paths_obj::sound(sound,library)))) {
HXLINE( 120)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
HXDLIN( 120)			::String EmbeddedSound = ( (::String)(::Paths_obj::sound(sound,library)) );
...
HXLINE( 120)				::openfl::utils::Assets_obj::getSound(EmbeddedSound,true);
            			}
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_126_browserLoad)
HXDLIN( 126)		::Sys_obj::command(HX_("/usr/bin/xdg-open",2e,30,af,50),::Array_obj< ::String >::__new(1)->init(0,site));
            	}
