...
HX_LOCAL_STACK_FRAME(_hx_pos_a69907c6a733237a_1103_set_leading,"flixel.text.FlxTextFormat","set_leading",0x68682d02,"flixel.text.FlxTextFormat.set_leading","flixel/text/FlxText.hx",1103,0xdf165a6e)
namespace flixel{
namespace text{
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_STACKFRAME(&_hx_pos_a69907c6a733237a_1103_set_leading)
HXLINE(1104)		this->format->leading = value;
