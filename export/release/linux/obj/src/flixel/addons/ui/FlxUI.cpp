...
HXLINE( 391)				if (::hx::IsInstanceEq( ddasset,butNotThisOne )) {
...
HXDLIN( 748)								_g = (_g + 1);
HXLINE( 750)								if (::hx::IsInstanceEq( child,inj_data )) {
...
HXLINE(1667)								if (::hx::IsInstanceEq( member,original )) {
...
HXLINE(1695)						if (::hx::IsInstanceEq( member,original )) {
...
HXDLIN(2732)				::flixel::IFlxSprite_obj::set_x(thing, ::Dynamic((thing->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) + -(( (Float)(thing->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) )))));
HXDLIN(2732)				::flixel::IFlxSprite_obj::set_y(thing, ::Dynamic((thing->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) + Y)));
            			}
...
HXLINE(3800)					Float _ui1 = _ui->y;
HXDLIN(3800)					_ui->set_y((_ui1 + ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(list_tabs->__get(0))));
            				}
...
HXLINE(4278)							 ::flixel::math::FlxPoint fh = sprite->offset;
HXDLIN(4278)							fh->set_x((fh->x - ( (Float)(text_x) )));
HXLINE(4279)							 ::flixel::math::FlxPoint fh1 = sprite->offset;
HXDLIN(4279)							fh1->set_y((fh1->y - ( (Float)(text_y) )));
...
HXLINE(4286)				 ::flixel::math::FlxPoint fh = ( ( ::flixel::FlxSprite)(fbs->label) )->offset;
HXDLIN(4286)				fh->set_x((fh->x - ( (Float)(text_x) )));
HXLINE(4287)				 ::flixel::math::FlxPoint fh1 = ( ( ::flixel::FlxSprite)(fbs->label) )->offset;
HXDLIN(4287)				fh1->set_y((fh1->y - ( (Float)(text_y) )));
HXLINE(4288)				if (::hx::IsNotNull( toggleSprite )) {
HXLINE(4290)					 ::flixel::math::FlxPoint fh = toggleSprite->offset;
HXDLIN(4290)					fh->set_x((fh->x - ( (Float)(text_x) )));
HXLINE(4291)					 ::flixel::math::FlxPoint fh1 = toggleSprite->offset;
HXDLIN(4291)					fh1->set_y((fh1->y - ( (Float)(text_y) )));
            				}
            			}
            		}
            		else {
HXLINE(4297)			 ::flixel::addons::ui::FlxUIButton fbu = ( ( ::flixel::addons::ui::FlxUIButton)(fb) );
HXLINE(4299)			 ::flixel::math::FlxPoint fh = ( ( ::flixel::FlxSprite)(fbu->label) )->offset;
HXDLIN(4299)			fh->set_x((fh->x - ( (Float)(text_x) )));
HXLINE(4300)			 ::flixel::math::FlxPoint fh1 = ( ( ::flixel::FlxSprite)(fbu->label) )->offset;
HXDLIN(4300)			fh1->set_y((fh1->y - ( (Float)(text_y) )));
            		}
...
HXDLIN(4642)		if (::hx::IsPointerEq( lineAxis,::flixel::addons::ui::LineAxis_obj::HORIZONTAL_dyn() )) {
...
HXLINE(4643)			if (::hx::IsPointerEq( lineAxis,::flixel::addons::ui::LineAxis_obj::HORIZONTAL_dyn() )) {
...
HXLINE(5658)		{
HXLINE(5658)			::flixel::IFlxSprite_obj::set_x(thing, ::Dynamic((thing->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) + X)));
HXDLIN(5658)			::flixel::IFlxSprite_obj::set_y(thing, ::Dynamic((thing->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) + Y)));
            		}
            	}
...
HXLINE(1579)		::flixel::IFlxSprite_obj::set_x(thing, ::Dynamic((thing->__Field(HX_("x",78,00,00,00),::hx::paccDynamic) + X)));
HXLINE(1580)		::flixel::IFlxSprite_obj::set_y(thing, ::Dynamic((thing->__Field(HX_("y",79,00,00,00),::hx::paccDynamic) + Y)));
            	}
