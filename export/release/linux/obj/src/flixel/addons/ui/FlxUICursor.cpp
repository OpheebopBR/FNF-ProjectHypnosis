...
HXLINE( 286)		if (::hx::IsInstanceEq( ::flixel::FlxG_obj::mouse,this->_newMouse )) {
...
HXLINE( 916)		widgetPoint->set_x((widgetPoint->x * Camera->totalScaleX));
HXLINE( 917)		widgetPoint->set_y((widgetPoint->y * Camera->totalScaleY));
...
HXLINE( 926)		Float widgetPoint1 = widgetPoint->x;
HXDLIN( 926)		widgetPoint->set_x((widgetPoint1 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_width(currWidget) / ( (Float)(2) ))));
HXLINE( 927)		Float widgetPoint2 = widgetPoint->y;
HXDLIN( 927)		widgetPoint->set_y((widgetPoint2 + (::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(currWidget) / ( (Float)(2) ))));
