...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FNFHypnosis", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FNFHypnosis", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FNFHypnosis";
		app.meta["name"] = "Friday Night Funkin': Project Hypnosis";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Project Hypnosis",
			width: 1280,
			x: null,
			y: null,
		};
