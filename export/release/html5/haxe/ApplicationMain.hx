...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AmalgamEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("AmalgamEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "AmalgamEngine";
		app.meta["name"] = "Friday Night Funkin': Amalgam Engine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Amalgam Engine",
			width: 1280,
			x: null,
			y: null,
		};
